...
void title(){//prints title of the program
    ...
    cout << "\tWelcome to Hand Cricket!!"<<endl<<endl<<endl<<endl;
    setcolorandbackground(10,0);//Green color
    cout<<  "         \t\t\tCheck your Guessing power!!"<<endl;
    setcolorandbackground(9,0);
...
bool toss(string player_name){    //returns if the player has won the toss or not
    ...
    cout << "\t(Note: If you choose another number you will lost the toss)"<<endl;
    setcolorandbackground(10,0);//Green color
    cout << "\tAns:";
    cin >>choice;
    ...
    if((t==1&&c==1 )||(t==2&&c==2)){
        setcolorandbackground(10,0);
        cout << "\n\n*******************\tCongratulations!"<<player_name<<"\tYou've won the Toss\t*******************" << endl;
        return true;
    }else{
        setcolorandbackground(12,0);
        cout << "\n\n\t*******************\tSorry!"<<player_name<<"\tYou've lost the Toss\t*******************" << endl;
        return false;
    }
}
...
void start_game(string player_name){
    ...
    setcolorandbackground(14,0);
    cout << "\n\tWhich format you would like to play?\n\t1. 1 Over Match\n\t2. 2 Over Match\n\t3. 5 Over Match\n\t\tEnter your choice: ";
    cin>>overs;
    ...
    cout << "FIRST INNINGS";
    setcolorandbackground(9,0);
    if(bat=="player") cout << "\n\n---------------------------------"<<player_name<<" You are Batting---------------------------------";
    else              cout << "\n\n---------------------------------"<<player_name<<" You are Bowling---------------------------------";
    ...
    if(bat=="player"){
        ...
        if(first>second) {
            ...
            cout << "\n\n\t\t\t\t"<<player_name<<" You Lost the Match!!";
             setcolorandbackground(10,0);//Green color
            cout << "\n\n\t\t\t\t"<<player_name<<"Better Luck next time";
        }
    }
    setcolorandbackground(9,0);
    cout <<"\n\n=============================================================================================================";
